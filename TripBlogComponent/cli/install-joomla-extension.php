...
class JoomlaExtensionInstallerCli extends JApplicationCli
{
	...
	public function execute()
	{
		...
		$packageFile = '/var/www/html/AESEC-5097/tests/releases/redshopb-v2.1.0-beta1.zip';
	...
	// Added in later
	public function isClient($params = false)
	{
		return true;
	}

	// Added in later
	public function allowCache($params = false)
	{
		return true;
	}

	// Added in later
	public function getLanguageFilter($params = false)
	{
		return;
	}
}
